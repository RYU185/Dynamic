...
INSERT INTO authority (authority_name) VALUES ('NON-USER');
 ...
 INSERT INTO user(user_id, company_name, name, password, gender, email,phone_number, business_number,business_type, exist_business_operator, point, user_authority)
    VALUES
        ('A1', NULL,'관리자', '$2b$12$A0kgVpplgbH3ZZ1E89441eacUXljTTt7nP8I3RdLtW0P6/CXdEnCm', 'MALE','admin@gmail.com', '010-1111-1111', NULL,NULL,false , 0, 'ADMIN');

INSERT INTO user (user_id, company_name, name, password, gender, email,phone_number, business_number,business_type, exist_business_operator, point, user_authority)
VALUES
    ('A2', '좋은상사', '이상수', '$2b$12$A0kgVpplgbH3ZZ1E89441eacUXljTTt7nP8I3RdLtW0P6/CXdEnCm', 'MALE','sangsu@gmail.com', '010-9123-4567', '123-45-67890','도소매업', true, 100, 'USER');
--
...
INSERT INTO review(text,rating,add_date,modified_date,user_id,product_id,is_active) VALUES('이용하기 편해요', 5 , '2025-01-13','2025-01-13','A2','S1',true);
INSERT INTO board(title,answer,add_date,user_id,is_active) VALUES('급여명세서 양식은 어떻게 작성하나요 ?', true,'2025-01-13','A2',true);
INSERT INTO comment(board_id,text,add_date,is_active) VALUES(1,'저도 궁금해요','2025-01-13',true);

INSERT INTO cart(user_id,product_id) VALUES ('A2','S1');
...
VALUES
('김철수', NULL, '직원', '2025-01-13','010-1234-5678', 'A2',1);

INSERT INTO purchase_history(product_id,user_id,price,purchase_date) VALUES('S1','A2',15000,'2025-01-13');

INSERT INTO user_product(user_id,product_id) VALUES('A2','S1');
